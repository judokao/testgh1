! function (e) {
    ...
    i = function () {
        ...
        if (i.options.dots === !0 && i.slideCount > i.options.slidesToShow) {
            for (i.$slider.addClass("slick-dotted"), s = e("<ul />").addClass(i.options.dotsClass), t = 0; t <= i.getDotCount(); t += 1) s.append(e("<li />").append(i.options.customPaging.call(this, i, t)));
            i.$dots = s.appendTo(i.options.appendDots), i.$dots.find("li").first().addClass("slick-active")
        }
        ...
        if ("window" === s.respondTo ? r = d : "slider" === s.respondTo ? r = a : "min" === s.respondTo && (r = Math.min(d, a)), s.options.responsive && s.options.responsive.length && null !== s.options.responsive) {
            n = null;
            for (o in s.breakpoints) s.breakpoints.hasOwnProperty(o) && (s.originalSettings.mobileFirst === !1 ? r < s.breakpoints[o] && (n = s.breakpoints[o]) : r > s.breakpoints[o] && (n = s.breakpoints[o]));
            null !== n ? null !== s.activeBreakpoint ? (n !== s.activeBreakpoint || t) && (s.activeBreakpoint = n, "unslick" === s.breakpointSettings[n] ? s.unslick(n) : (s.options = e.extend({}, s.originalSettings, s.breakpointSettings[n]), i === !0 && (s.currentSlide = s.options.initialSlide), s.refresh(i)), l = n) : (s.activeBreakpoint = n, "unslick" === s.breakpointSettings[n] ? s.unslick(n) : (s.options = e.extend({}, s.originalSettings, s.breakpointSettings[n]), i === !0 && (s.currentSlide = s.options.initialSlide), s.refresh(i)), l = n) : null !== s.activeBreakpoint && (s.activeBreakpoint = null, s.options = s.originalSettings, i === !0 && (s.currentSlide = s.options.initialSlide), s.refresh(i), l = n), i || l === !1 || s.$slider.trigger("breakpoint", [s, l])
        }
    }, i.prototype.changeSlide = function (i, t) {
        var n, r, l, s = this,
            o = e(i.currentTarget);
        switch (o.is("a") && i.preventDefault(), o.is("li") || (o = o.closest("li")), l = s.slideCount % s.options.slidesToScroll !== 0, n = l ? 0 : (s.slideCount - s.currentSlide) % s.options.slidesToScroll, i.data.message) {
            case "previous":
                r = 0 === n ? s.options.slidesToScroll : s.options.slidesToShow - n, s.slideCount > s.options.slidesToShow && s.slideHandler(s.currentSlide - r, !1, t);
                break;
            case "next":
                r = 0 === n ? s.options.slidesToScroll : n, s.slideCount > s.options.slidesToShow && s.slideHandler(s.currentSlide + r, !1, t);
                break;
            case "index":
                var a = 0 === i.data.index ? 0 : i.data.index || o.index() * s.options.slidesToScroll;
                s.slideHandler(s.checkNavigable(a), !1, t), o.children().trigger("focus");
                break;
            default:
                return
        }
        ...
        var t, s, n, r, i = this,
            o = 0;
        return i.slideOffset = 0, s = i.$slides.first().outerHeight(!0), i.options.infinite === !0 ? (i.slideCount > i.options.slidesToShow && (i.slideOffset = i.slideWidth * i.options.slidesToShow * -1, r = -1, i.options.vertical === !0 && i.options.centerMode === !0 && (2 === i.options.slidesToShow ? r = -1.5 : 1 === i.options.slidesToShow && (r = -2)), o = s * i.options.slidesToShow * r), i.slideCount % i.options.slidesToScroll !== 0 && e + i.options.slidesToScroll > i.slideCount && i.slideCount > i.options.slidesToShow && (e > i.slideCount ? (i.slideOffset = (i.options.slidesToShow - (e - i.slideCount)) * i.slideWidth * -1, o = (i.options.slidesToShow - (e - i.slideCount)) * s * -1) : (i.slideOffset = i.slideCount % i.options.slidesToScroll * i.slideWidth * -1, o = i.slideCount % i.options.slidesToScroll * s * -1))) : e + i.options.slidesToShow > i.slideCount && (i.slideOffset = (e + i.options.slidesToShow - i.slideCount) * i.slideWidth, o = (e + i.options.slidesToShow - i.slideCount) * s), i.slideCount <= i.options.slidesToShow && (i.slideOffset = 0, o = 0), i.options.centerMode === !0 && i.slideCount <= i.options.slidesToShow ? i.slideOffset = i.slideWidth * Math.floor(i.options.slidesToShow) / 2 - i.slideWidth * i.slideCount / 2 : i.options.centerMode === !0 && i.options.infinite === !0 ? i.slideOffset += i.slideWidth * Math.floor(i.options.slidesToShow / 2) - i.slideWidth : i.options.centerMode === !0 && (i.slideOffset = 0, i.slideOffset += i.slideWidth * Math.floor(i.options.slidesToShow / 2)), t = i.options.vertical === !1 ? e * i.slideWidth * -1 + i.slideOffset : e * s * -1 + o, i.options.variableWidth === !0 && (n = i.$slideTrack.children(".slick-slide").eq(i.slideCount <= i.options.slidesToShow || i.options.infinite === !1 ? e : e + i.options.slidesToShow), t = i.options.rtl === !0 ? n[0] ? -1 * (i.$slideTrack.width() - n[0].offsetLeft - n.width()) : 0 : n[0] ? -1 * n[0].offsetLeft : 0, i.options.centerMode === !0 && (n = i.$slideTrack.children(".slick-slide").eq(i.slideCount <= i.options.slidesToShow || i.options.infinite === !1 ? e : e + i.options.slidesToShow + 1), t = i.options.rtl === !0 ? n[0] ? -1 * (i.$slideTrack.width() - n[0].offsetLeft - n.width()) : 0 : n[0] ? -1 * n[0].offsetLeft : 0, t += (i.$list.width() - n.outerWidth()) / 2)), t
        ...
        var o, e = this,
            ...
            t = 0,
            s = [];
        for (e.options.infinite === !1 ? o = e.slideCount : (i = -1 * e.options.slidesToScroll, t = -1 * e.options.slidesToScroll, o = 2 * e.slideCount); o > i;) s.push(i), i = t + e.options.slidesToScroll, t += e.options.slidesToScroll <= e.options.slidesToShow ? e.options.slidesToScroll : e.options.slidesToShow;
        return s
        ...
        for (var o = i.currentSlide, n = o + i.options.slidesToShow; n > o; o++) i.options.focusOnChange ? i.$slides.eq(o).attr({
            tabindex: "0"
        ...
        var t, s, o, n, i = this;
        if (i.options.centerMode === !0 ? i.options.infinite === !0 ? (o = i.currentSlide + (i.options.slidesToShow / 2 + 1), n = o + i.options.slidesToShow + 2) : (o = Math.max(0, i.currentSlide - (i.options.slidesToShow / 2 + 1)), n = 2 + (i.options.slidesToShow / 2 + 1) + i.currentSlide) : (o = i.options.infinite ? i.options.slidesToShow + i.currentSlide : i.currentSlide, n = Math.ceil(o + i.options.slidesToShow), i.options.fade === !0 && (o > 0 && o--, n <= i.slideCount && n++)), t = i.$slider.find(".slick-slide").slice(o, n), "anticipated" === i.options.lazyLoad)
            for (var l = o - 1, a = n, d = i.$slider.find(".slick-slide"), c = 0; c < i.options.slidesToScroll; c++) 0 > l && (l = i.slideCount - 1), t = t.add(d.eq(l)), t = t.add(d.eq(a)), l--, a++;
        r(t), i.slideCount <= i.options.slidesToShow ? (s = i.$slider.find(".slick-slide"), r(s)) : i.currentSlide >= i.slideCount - i.options.slidesToShow ? (s = i.$slider.find(".slick-cloned").slice(0, i.options.slidesToShow), r(s)) : 0 === i.currentSlide && (s = i.$slider.find(".slick-cloned").slice(-1 * i.options.slidesToShow), r(s))
        ...
        i = i || 1;
        var o, n, r, l, a, t = this,
            s = e("img[data-lazy]", t.$slider);
        s.length ? (o = s.first(), n = o.attr("data-lazy"), r = o.attr("data-srcset"), l = o.attr("data-sizes") || t.$slider.attr("data-sizes"), a = document.createElement("img"), a.onload = function () {
            r && (o.attr("srcset", r), l && o.attr("sizes", l)), o.attr("src", n).removeAttr("data-lazy data-srcset data-sizes").removeClass("slick-loading"), t.options.adaptiveHeight === !0 && t.setPosition(), t.$slider.trigger("lazyLoaded", [t, o, n]), t.progressiveLazyLoad()
        }, a.onerror = function () {
            3 > i ? setTimeout(function () {
                t.progressiveLazyLoad(i + 1)
            }, 500) : (o.removeAttr("data-lazy").removeClass("slick-loading").addClass("slick-lazyload-error"), t.$slider.trigger("lazyLoadError", [t, o, n]), t.progressiveLazyLoad())
        }, a.src = n) : t.$slider.trigger("allImagesLoaded", [t])
    }, i.prototype.refresh = function (i) {
        var s, o, t = this;
        o = t.slideCount - t.options.slidesToShow, !t.options.infinite && t.currentSlide > o && (t.currentSlide = o), t.slideCount <= t.options.slidesToShow && (t.currentSlide = 0), s = t.currentSlide, t.destroy(!0), e.extend(t, t.initials, {
            currentSlide: s
        ...
        if ("array" === e.type(n) && n.length) {
            ...
            for (t in n)
                if (o = i.breakpoints.length - 1, n.hasOwnProperty(t)) {
                    for (s = n[t].breakpoint; o >= 0;) i.breakpoints[o] && i.breakpoints[o] === s && i.breakpoints.splice(o, 1), o--;
                    i.breakpoints.push(s), i.breakpointSettings[s] = n[t].settings
        ...
        var t, s, o, n, l, i = this,
            r = !1;
        if ("object" === e.type(arguments[0]) ? (o = arguments[0], r = arguments[1], l = "multiple") : "string" === e.type(arguments[0]) && (o = arguments[0], n = arguments[1], r = arguments[2], "responsive" === arguments[0] && "array" === e.type(arguments[1]) ? l = "responsive" : "undefined" != typeof arguments[1] && (l = "single")), "single" === l) i.options[o] = n;
        else if ("multiple" === l) e.each(o, function (e, t) {
            i.options[e] = t
        });
        else if ("responsive" === l)
            for (s in n)
                if ("array" !== e.type(i.options.responsive)) i.options.responsive = [n[s]];
                else {
                    for (t = i.options.responsive.length - 1; t >= 0;) i.options.responsive[t].breakpoint === n[s].breakpoint && i.options.responsive.splice(t, 1), t--;
        ...
        if (s = i.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"), i.$slides.eq(e).addClass("slick-current"), i.options.centerMode === !0) {
            ...
            t = Math.floor(i.options.slidesToShow / 2), i.options.infinite === !0 && (e >= t && e <= i.slideCount - 1 - t ? i.$slides.slice(e - t + r, e + t + 1).addClass("slick-active").attr("aria-hidden", "false") : (o = i.options.slidesToShow + e, s.slice(o - t + 1 + r, o + t + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === e ? s.eq(s.length - 1 - i.options.slidesToShow).addClass("slick-center") : e === i.slideCount - 1 && s.eq(i.options.slidesToShow).addClass("slick-center")), i.$slides.eq(e).addClass("slick-center")
        } else e >= 0 && e <= i.slideCount - i.options.slidesToShow ? i.$slides.slice(e, e + i.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : s.length <= i.options.slidesToShow ? s.addClass("slick-active").attr("aria-hidden", "false") : (n = i.slideCount % i.options.slidesToShow, o = i.options.infinite === !0 ? i.options.slidesToShow + e : e, i.options.slidesToShow == i.options.slidesToScroll && i.slideCount - e < i.options.slidesToShow ? s.slice(o - (i.options.slidesToShow - n), o + n).addClass("slick-active").attr("aria-hidden", "false") : s.slice(o, o + i.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false"));
        ...
        if (i.options.fade === !0 && (i.options.centerMode = !1), i.options.infinite === !0 && i.options.fade === !1 && (s = null, i.slideCount > i.options.slidesToShow)) {
            ...
            for (t = 0; t < o + i.slideCount; t += 1) s = t, e(i.$slides[s]).clone(!0).attr("id", "").attr("data-slick-index", s + i.slideCount).appendTo(i.$slideTrack).addClass("slick-cloned");
        ...
        var s, o, n, r, d, l = null,
            a = this;
        return i = i || !1, a.animating === !0 && a.options.waitForAnimate === !0 || a.options.fade === !0 && a.currentSlide === e ? void 0 : (i === !1 && a.asNavFor(e), s = e, l = a.getLeft(s), r = a.getLeft(a.currentSlide), a.currentLeft = null === a.swipeLeft ? r : a.swipeLeft, a.options.infinite === !1 && a.options.centerMode === !1 && (0 > e || e > a.getDotCount() * a.options.slidesToScroll) ? void(a.options.fade === !1 && (s = a.currentSlide, t !== !0 && a.slideCount > a.options.slidesToShow ? a.animateSlide(r, function () {
            a.postSlide(s)
        }) : a.postSlide(s))) : a.options.infinite === !1 && a.options.centerMode === !0 && (0 > e || e > a.slideCount - a.options.slidesToScroll) ? void(a.options.fade === !1 && (s = a.currentSlide, t !== !0 && a.slideCount > a.options.slidesToShow ? a.animateSlide(r, function () {
            a.postSlide(s)
        }) : a.postSlide(s))) : (a.options.autoplay && clearInterval(a.autoPlayTimer), o = 0 > s ? a.slideCount % a.options.slidesToScroll !== 0 ? a.slideCount - a.slideCount % a.options.slidesToScroll : a.slideCount + s : s >= a.slideCount ? a.slideCount % a.options.slidesToScroll !== 0 ? 0 : s - a.slideCount : s, a.animating = !0, a.$slider.trigger("beforeChange", [a, a.currentSlide, o]), n = a.currentSlide, a.currentSlide = o, a.setSlideClasses(a.currentSlide), a.options.asNavFor && (d = a.getNavTarget(), d = d.slick("getSlick"), d.slideCount <= d.options.slidesToShow && d.setSlideClasses(a.currentSlide)), a.updateDots(), a.updateArrows(), a.options.fade === !0 ? (t !== !0 ? (a.fadeSlideOut(n), a.fadeSlide(o, function () {
            a.postSlide(o)
        })) : a.postSlide(o), void a.animateHeight()) : void(t !== !0 && a.slideCount > a.options.slidesToShow ? a.animateSlide(l, function () {
            a.postSlide(o)
        }) : a.postSlide(o))))
        ...
        if (i.touchObject.edgeHit === !0 && i.$slider.trigger("edge", [i, i.swipeDirection()]), i.touchObject.swipeLength >= i.touchObject.minSwipe) {
            ...
            "vertical" != s && (i.slideHandler(t), i.touchObject = {}, i.$slider.trigger("swipe", [i, s]))
        ...
        var s, o, n, r, l, a, i = this;
        return l = void 0 !== e.originalEvent ? e.originalEvent.touches : null, !i.dragging || i.scrolling || l && 1 !== l.length ? !1 : (s = i.getLeft(i.currentSlide), i.touchObject.curX = void 0 !== l ? l[0].pageX : e.clientX, i.touchObject.curY = void 0 !== l ? l[0].pageY : e.clientY, i.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(i.touchObject.curX - i.touchObject.startX, 2))), a = Math.round(Math.sqrt(Math.pow(i.touchObject.curY - i.touchObject.startY, 2))), !i.options.verticalSwiping && !i.swiping && a > 4 ? (i.scrolling = !0, !1) : (i.options.verticalSwiping === !0 && (i.touchObject.swipeLength = a), o = i.swipeDirection(), void 0 !== e.originalEvent && i.touchObject.swipeLength > 4 && (i.swiping = !0, e.preventDefault()), r = (i.options.rtl === !1 ? 1 : -1) * (i.touchObject.curX > i.touchObject.startX ? 1 : -1), i.options.verticalSwiping === !0 && (r = i.touchObject.curY > i.touchObject.startY ? 1 : -1), n = i.touchObject.swipeLength, i.touchObject.edgeHit = !1, i.options.infinite === !1 && (0 === i.currentSlide && "right" === o || i.currentSlide >= i.getDotCount() && "left" === o) && (n = i.touchObject.swipeLength * i.options.edgeFriction, i.touchObject.edgeHit = !0), i.swipeLeft = i.options.vertical === !1 ? s + n * r : s + n * (i.$list.height() / i.listWidth) * r, i.options.verticalSwiping === !0 && (i.swipeLeft = s + n * r), i.options.fade === !0 || i.options.touchMove === !1 ? !1 : i.animating === !0 ? (i.swipeLeft = null, !1) : void i.setCSS(i.swipeLeft)))
        ...
        var n, r, e = this,
            ...
            o = e.length;
        for (n = 0; o > n; n++)
            if ("object" == typeof t || "undefined" == typeof t ? e[n].slick = new i(e[n], t) : r = e[n].slick[t].apply(e[n].slick, s), "undefined" != typeof r) return r;
        return e
    }
});